...
class ArchiveUtilTestCase(support.TempdirManager,
    ...
    @unittest.skipUnless(zlib, "requires zlib")
    @unittest.skipUnless(can_fs_encode(u'  rchiv'),
    ...
    def test_make_tarball_unicode_latin1(self):
        ...
        latin characters.
        """
        self._make_tarball(u'  rchiv') # note this isn't a real word

    @unittest.skipUnless(zlib, "requires zlib")
    @unittest.skipUnless(can_fs_encode(u'                  '),
        'File system cannot handle this filename')
    def test_make_tarball_unicode_extended(self):
        ...
        """
        self._make_tarball(u'                  ') # japanese for archive
